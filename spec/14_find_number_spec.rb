...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 0 and max is 9' do
      it 'returns 4' do
        expect(subject.make_guess).to eq(4)
      end
    end
    ...
    context 'when min is 5 and max is 9' do
      subject(:test_2) { described_class.new(5, 9, number_guessing) }
      it 'returns 7' do
    ...
    context 'when min is 8 and max is 9' do
      subject(:test_3) { described_class.new(8, 9, number_guessing) }
      it 'returns 8' do
    ...
    context 'when min is 0 and max is 3' do
      subject(:test_4) { described_class.new(0, 3, number_guessing) }
      it 'returns 1' do
    ...
    context 'when min and max both equal 3' do
      subject(:test_5) { described_class.new(3, 3, number_guessing) }
      it 'returns 3' do
  ...
  describe '#game_over?' do
    let(:game_over_rand) { double('random_number', value: val_var) }
    game_over_guess = 5
    subject(:game_over_test) { described_class.new(0, 9, game_over_rand, game_over_guess) }
    ...
    context 'when guess and random_number are not equal' do
      ...
      it 'is not game over' do
        expect(subject.game_over?).to_not be true
      end
    end
  end
